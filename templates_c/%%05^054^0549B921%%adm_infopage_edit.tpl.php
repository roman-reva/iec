<?php /* Smarty version 2.6.14, created on 2011-08-19 16:47:54
         compiled from adm_infopage_edit.tpl */ ?>
...
"><br /><br />
	...
	<input type="text" name="menutitle" class="long" value="<?php echo $this->_tpl_vars['data']['menutitle']; ?>
"><br /><br />
	...
	<?php if ($this->_tpl_vars['data']['background'] == ""): ?>
		<input type="file" name="background" class="short" value="<?php echo $this->_tpl_vars['data']['name']; ?>
"><br />
			<small>(Для того, чтобы изображение занимало всю область страницы, оно должно быть размером 811 x 406 пикселей)</small>
	<?php else: ?>
		<img src="../<?php echo $this->_tpl_vars['data']['background']; ?>
" border="0" width="200"><br />
		<a href="?id=<?php echo $this->_tpl_vars['data']['id']; ?>
&delimage" onclick="return confirm('Вы действительно хотите удалить изображение?')">Удалить изображение</a>
	<?php endif; ?>
	<br /><br />
	<?php endif; ?>
