<?php /* Smarty version 2.6.14, created on 2011-08-19 16:13:16
         compiled from adm_group_edit.tpl */ ?>
...
"><br /><br />
	...
	<textarea name="details" cols="80" rows="5"><?php echo $this->_tpl_vars['data']['details']; ?>
</textarea><br /><br />
	
	<span class="head3">Полное описание проекта</span><br />
	<textarea name="text" cols="80" rows="10"><?php echo $this->_tpl_vars['data']['text']; ?>
</textarea><br /><br />
	
	<?php if ($this->_tpl_vars['data']['id'] > 0): ?>
	<span class="head3">Картинка проекта</span><br />
	<?php if ($this->_tpl_vars['data']['image'] == ""): ?>
		<input type="file" name="picture" class="short" value="<?php echo $this->_tpl_vars['data']['name']; ?>
">
	<?php else: ?>
